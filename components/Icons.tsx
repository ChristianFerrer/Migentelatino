...
// Mercado palette — flat icons: warm/fresh fills on light cards, espresso detail.
//   Chili #F0473D · Mango #F7B733 · Green #15A56A · Teal #0FB0A4 · Espresso #2B1A12
const K = "#2B1A12"; // detail / outline
const icons: Record<IconKey, ReactElement> = {
  grocery: (
    <>
      <rect x="10" y="14" width="28" height="26" rx="4" fill="#15A56A" />
      <path d="M16 14a8 8 0 0 1 16 0" stroke={K} strokeWidth="2.5" strokeLinecap="round" fill="none" />
      <circle cx="19" cy="25" r="2.5" fill="#F0473D" />
      <circle cx="29" cy="25" r="2.5" fill="#F7B733" />
    </>
  ),
  drink: (
    <>
      <path d="M16 12h16l-2 26a4 4 0 0 1-4 4h-4a4 4 0 0 1-4-4L16 12Z" fill="#0FB0A4" />
      <path d="M17 20h14" stroke={K} strokeWidth="2.5" />
      <path d="M24 6v6" stroke="#0FB0A4" strokeWidth="3" strokeLinecap="round" />
    </>
  ),
  snack: (
    <>
      ...
      <circle cx="24" cy="24" r="4" fill="#F7B733" />
    </>
  ),
  spice: (
    <>
      <rect x="16" y="18" width="16" height="22" rx="3" fill="#F7B733" />
  ...
  fresh: (
    <>
      ...
      <path d="M24 16c0-4 3-7 7-7-1 4-3 7-7 7Z" fill="#15A56A" />
    </>
  ),
  frozen: (
    <>
      <circle cx="24" cy="24" r="14" fill="#0FB0A4" />
  ...
  truck: (
    <>
      <rect x="6" y="16" width="22" height="16" rx="2" fill="#F7B733" />
      <path d="M28 22h7l5 6v4H28V22Z" fill="#15A56A" />
  ...
  mail: (
    <>
      <rect x="8" y="12" width="32" height="24" rx="3" fill="#15A56A" />
