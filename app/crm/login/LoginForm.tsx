...
export function LoginForm({ configured }: { configured: boolean }) {
  ...
  const field =
    "w-full rounded-xl border border-ink/10 bg-white px-4 py-3 text-[15px] font-medium text-ink outline-none transition placeholder:text-ink/40 focus:border-[#19b4ae]/60 focus:ring-4 focus:ring-[#19b4ae]/15";
      ...
      <div className="w-full max-w-sm">
        ...
        >
          ...
          <button
            type="submit"
            disabled={loading}
            className="mt-6 w-full rounded-full bg-[#19b4ae] px-7 py-3.5 text-base font-bold text-white transition hover:brightness-110 active:scale-[0.99] disabled:opacity-60"
          >
